...
AWS Toolkit For Visual Studio Code supports local debugging for serverless applications through VS Code's . Since this application was created by the AWS Toolkit, launch configurations for all included handlers have been generated and can be found in the menu next to the Run button:

* api-stay-smart:HelloWorldFunction (nodejs18.x)
* API api-stay-smart:HelloWorldFunction (nodejs18.x)
